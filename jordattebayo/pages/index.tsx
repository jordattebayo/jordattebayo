...
const _projectData = [
  {
    ...
    tech: 'JavaScript, ReactJS, GraphQL, Gatsby, and Netlify CMS',
  ...
  },
  {
    ...
    features: 'Provides current weather and records it with each journal entry',
    tech: 'HTML, CSS, JavaScript, NodeJS',
    live: '',
    git: 'https://github.com/jordattebayo/fend/tree/refresh-2019/projects/weather-journal-app',
  },
  {
    id: '6',
    title: 'Photo Blog',
      ...
      <main className='grid'>
        <div>
          <div className='hero-container'>
            <animated.h1 style={props} className='hero-heading'>
              Hello
            </animated.h1>
