...
Below is how we can extract the jsx to create a new Card component.
...
return (
	<div>
		...
		<p>Blog post text</p>
		<div className="cards-container">
			<Card cardText={"Card Text"} buttonText={"CTA Button 1"} />
			<Card cardText={"Card Text"} buttonText={"CTA Button 2"} />
			<Card cardText={"Card Text"} buttonText={"CTA Button 3"} />
		</div>
	<div>
	)
};
...
[https://images.app.goo.gl/KEpx5vUTpsK2bagG7](https://images.app.goo.gl/KEpx5vUTpsK2bagG7)
...
[https://images.app.goo.gl/A9fPTgVffsowSbWE7](https://images.app.goo.gl/A9fPTgVffsowSbWE7)
...
I’ve included a github repo to highlight what this may look like [https://github.com/jordattebayo/component-example](https://github.com/jordattebayo/component-example).
